                        ...
                        <form className='reservationForm'>
                            ...
                            <div className='reservationNameLastName'>
                                <div className="reservationInput">
                                    ...
                                    <input type="text" placeholder="Ingrese su nombre" className="inputRes" />
                                </div>
                                <div className="reservationInput">
                                    <h5 className='reservationInputTitle'>Apellido</h5>
                                    <input name="text" placeholder="Ingrese su apellido" className="inputRes" />
                                </div>
                            </div>
                            <div className='reservationDataEmailCity'>
                                <div className="reservationInput">
                                    <h5 className='reservationInputTitle'>Correo electrónico</h5>
                                    <input type="email" placeholder="Ingrese su correo electrónico" className="inputRes" />
                                </div>
                                <div className="reservationInput">
                                    <h5 className='reservationInputTitle'>Ciudad</h5>
                                    <input type="city" placeholder="Ingrese su ciudad" className="inputRes" />
                                </div>
                            </div>
                        </form>
                    </div>
